...
**Files:**
- Create: `ios/Summa.xcodeproj` (via Xcode)
- Create: `ios/Summa/` (app source directory)

**Step 1: Create the Xcode project**

Open Xcode and create a new project:
1. File → New → Project → iOS → App
2. Product Name: **Summa**
...
1. Select the Summa target → Signing & Capabilities
...
```bash
cd ios && xcodebuild -scheme Summa -destination 'platform=iOS Simulator,name=iPhone 16' build
```
...
**Files:**
- Create: `ios/Summa/Models/Asset.swift`
- Create: `ios/Summa/Models/AssetCategory.swift`
- Create: `ios/Summa/Models/UserSettings.swift`
...
**Files:**
- Modify: `ios/Summa/SummaApp.swift`
...
**Files:**
- Create: `ios/Summa/Services/PriceAPIClient.swift`
- Create: `ios/Summa/Services/PriceModels.swift`
...
**Files:**
- Create: `ios/Summa/Logic/PortfolioCalculator.swift`
- Create: `ios/SummaTests/PortfolioCalculatorTests.swift`
...
```bash
cd ios && xcodebuild test -scheme Summa -destination 'platform=iOS Simulator,name=iPhone 16'
```
...
**Files:**
- Create: `ios/Summa/Logic/RiskCalculator.swift`
- Create: `ios/SummaTests/RiskCalculatorTests.swift`
...
**Files:**
- Create: `ios/Summa/Logic/ProjectionEngine.swift`
- Create: `ios/SummaTests/ProjectionEngineTests.swift`
...
**Files:**
- Create: `ios/Summa/Logic/InsightsEngine.swift`
- Create: `ios/SummaTests/InsightsEngineTests.swift`
...
**Files:**
- Modify: `ios/Summa/ContentView.swift`
- Create: `ios/Summa/Views/DashboardView.swift`
- Create: `ios/Summa/Views/ProjectionsView.swift`
- Create: `ios/Summa/Views/InsightsView.swift`
...
**Files:**
- Create: `ios/Summa/Views/AddAssetView.swift`
- Create: `ios/Summa/Data/AssetCatalog.swift`
...
**Files:**
- Modify: `ios/Summa/Views/DashboardView.swift`
- Create: `ios/Summa/ViewModels/DashboardViewModel.swift`
...
**Files:**
- Modify: `ios/Summa/Views/ProjectionsView.swift`
...
**Files:**
- Modify: `ios/Summa/Views/InsightsView.swift`
...
**Files:**
- Create: `ios/Summa/Logic/PremiumGate.swift`
- Modify: `ios/Summa/Views/AddAssetView.swift`
...
**Files:**
- Create: `ios/Summa/Views/AssetListView.swift`
- Modify: `ios/Summa/Views/DashboardView.swift`
